...
#include "ChickenSkin.h"

AChickenSkinCharacter::AChickenSkinCharacter()
{
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking/Aiming
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AChickenSkinCharacter::LookInput);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AChickenSkinCharacter::LookInput);
	}
	else
	{
...
void AChickenSkinCharacter::MoveInput(const FInputActionValue& Value)
{
...
void AChickenSkinCharacter::LookInput(const FInputActionValue& Value)
{
...
void AChickenSkinCharacter::DoAim(float Yaw, float Pitch)
{
	if (GetController())
	{
